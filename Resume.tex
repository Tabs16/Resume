...
% Center the name over the entire width of resume:
 ...
 \moveleft.5\hoffset\centerline{\url{https://tabs16.github.io}}
  \moveleft.5\hoffset\centerline{\bf +91-756 868 8665}
  \moveleft.5\hoffset\centerline{\bf tabs16w@gmail.com}
...
\hline
B.Tech & 2019 (Expected) & LNM Institute of Information Technology, Jaipur & 8.92/10 \\
\hline
...
\section{ACHIEVEMENTS}
	\begin{itemize}
		\item Outreachy`17 and Google Summer of Code(GSOC)`17 participant under Sugar Labs for Music Blocks project. 
